...
**Remediation update:** S01–S03, S05, and S06 merged in PRs #26–#28. S08, S09, and R03 are implemented in the [resource-bounds batch](fix-resource-bounds-2026-09-10.md). See the [S01–S03 remediation record](security-fixes-2026-09-09.md) and [current plan](security-remediation-plan.md) for validation and remaining work. Findings below describe the original reviewed revision.
